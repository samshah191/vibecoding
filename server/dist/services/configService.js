...
class ConfigService {
    ...
    static getComponentLibraryOptions() {
        return [
            {
                id: 'material-ui',
    ...
    static getStateManagementOptions() {
        return [
            {
                id: 'context',
                name: 'React Context',
    ...
    static getCompatibleOptions(framework) {
        return {
            componentLibraries: this.getComponentLibraryOptions().filter(lib => lib.framework.includes(framework)),
            stateManagement: this.getStateManagementOptions().filter(sm => sm.framework.includes(framework)),
            routing: this.getRoutingOptions().filter(r => r.framework.includes(framework))
        };
    }
    // Get default configuration for a framework
    static getDefaultConfig(framework) {
